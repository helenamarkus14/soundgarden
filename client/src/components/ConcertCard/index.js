...
const ConcertCard = (props) => {
  ...
  return (
    <div className="w-96 mt-6 ml-8 bg-white pb-2 rounded-lg border border-black shadow-md dark:bg-black dark:border-black">
        <h3 className="mt-2 mb-2 px-7 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{props.artist}</h3>
        ...
        element={<ConcertView />} className="text-yellow bg-black font-bold rounded-full px-3 py-1 text-xl outline-none focus:outline-none ml-5 mr-1 mb-1 ease-linear transition-all duration-150" type="button"> Details </NavLink>
    </div>
